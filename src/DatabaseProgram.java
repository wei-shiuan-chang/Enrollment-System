...
public class DatabaseProgram extends Frame {
	public static void main(String[] args) throws SQLException {
		 ...
		 * Dimension(800, 500)); frame.getContentPane().add(emptyLabel,
		 * BorderLayout.CENTER);
		 * 
		...
		try {
			...
			myConn = DriverManager.getConnection("jdbc:mysql://localhost:3306/test?serverTimezone=UTC", "root",
					"/*Hide password*/");
